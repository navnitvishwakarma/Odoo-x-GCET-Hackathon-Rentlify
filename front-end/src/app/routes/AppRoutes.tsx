...
import ProductsPage from '../pages/customer/ProductsPage'; // 🛍️ Products Page
import CheckoutPage from '../pages/customer/CheckoutPage'; // 💳 Checkout Page
import OrderConfirmationPage from '../pages/customer/OrderConfirmationPage'; // ✅ Order Confirmation
    ...
    return (
        <Routes>
            ...
            <Route element={<MainLayout />}>
                ...
                <Route path="/products" element={<ProductsPage />} /> {/* 🛍️ Products Listing */}
                <Route path="/checkout" element={<CheckoutPage />} /> {/* 💳 Checkout */}
                <Route path="/cart" element={<CheckoutPage />} /> {/* 🛒 Cart Alias */}
                <Route path="/order-confirmation" element={<OrderConfirmationPage />} /> {/* ✅ Success */}
