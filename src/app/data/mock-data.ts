...
export const categories = [
  ...
  { id: 'appliances', name: 'Home Appliances', icon: 'Microwave' },
  { id: 'party', name: 'Party & Events', icon: 'PartyPopper' },
];
...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    images: ['drone-aerial-photography'],
    location: 'Miami, FL',
    vendorId: 'v1',
    vendorName: 'ProGear Rentals',
    rating: 4.9,
  ...
  },
  {
    ...
    images: ['espresso-machine-coffee'],
...
export const mockBookings: Booking[] = [
  ...
  },
  {
    ...
    productImage: 'tesla-electric-car',
    customerId: 'c2',
